...
over_eight_hours <- sum(week1_sleep > 8)

# Print the result
print(over_eight_hours)
...
# Combine the student vectors
students_combined <- c(student01, student02, student03)

# Create a matrix from the combined vector
# Set byrow to TRUE to fill the matrix by rows, and nrow to 3 because there are 3 students
...
# Add student04 to the grades matrix
grades <- rbind(grades, student04)

# Print the updated grades matrix
print(grades)
...
# Add assignment04 to the grades matrix
...
# Add the students names to the rows
...
total_assign_points <- colSums(grades, na.rm = TRUE)

# Print the total points
print(total_assign_points)


## Total points for each student using `rowSums()`
total_student_points <- rowSums(grades, na.rm = TRUE)
...
bonus <- matrix(0.10, nrow = nrow(grades), ncol = ncol(grades))

# Add the bonus to grades
weighted_grades <- grades * bonus + grades
...
# Create a factor from the genres vector
factor_genre_vector <- factor(genres_vector)

# Print the factor_genre_vector
...
# Print the factor_recommendations_vector
...
# Print the characters_df dataframe
print(characters_df)
...
# Print the sorted_characters_df dataframe
...
# print ringbearers_df dataframe
